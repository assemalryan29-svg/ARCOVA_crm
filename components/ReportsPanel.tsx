...
export default function ReportsPanel({ leads = [], tasks = [], userRole = 'sales' }) {
  ...
  return (
    <div style={{display:'grid',gap:'1rem'}}>
      ...
      {can(userRole, PERMISSIONS.REPORTS_EXPORT) && <button type='button' onClick={downloadCsv} style={{justifySelf:'start',padding:'0.55rem 0.9rem',background:'#b08a4a',color:'#fffaf0',border:0,borderRadius:'5px',fontWeight:700}}>تصدير التقرير CSV</button>}
    </div>
  );
}