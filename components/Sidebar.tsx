  ...
  return (
    <aside className="arcova-sidebar" dir="rtl">
      ...
      <style jsx>{`
        ...
        .arcova-nav-link { appearance: none; display: flex; align-items: center; justify-content: space-between; width: 100%; padding: 12px; border: 0; border-radius: 12px; box-sizing: border-box; color: #cbd5e1; background: transparent; transition: background .2s ease, color .2s ease, transform .2s ease; cursor: pointer; touch-action: manipulation; -webkit-tap-highlight-color: transparent; font: inherit; text-align: right; position: relative; z-index: 30; pointer-events: auto; }
