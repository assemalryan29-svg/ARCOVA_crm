...
export async function getCurrentIdentity() {
  ...
  // user_roles is the canonical authorization source. Never fall back to
  // profiles.role or a default role when the canonical row is missing.
  const role = roleRow?.active && roleRow?.role ? normalizeRole(roleRow.role) : null;
