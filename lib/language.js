...
export const translations = {
  ar: {
    menu: 'القائمة الرئيسية', dashboard: 'الرئيسية', customers: 'العملاء / Customer 360', folders: 'مجلدات العملاء', addEmployee: 'إضافة موظف', pipeline: 'مراحل الصفقات', followups: 'المتابعات', projects: 'المشاريع والوحدات', tasks: 'المهام', campaigns: 'الحملات', operations: 'الصفقات والحجوزات', reports: 'التقارير', automation: 'الأتمتة', leaderboard: 'أداء المبيعات', audit: 'سجل التدقيق', team: 'فريق العمل والصلاحيات', settings: 'الإعدادات', system: 'نظام إدارة العملاء والعقارات',
