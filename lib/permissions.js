...
const ROLE_PERMISSIONS = {
  ...
  manager: new Set([
    ...
    'pipeline.view','followups.view','followups.manage','calls.view','calls.manage','appointments.view','appointments.manage',
  ...
  team_leader: new Set([
    'dashboard.view','leads.view','leads.create','leads.update','pipeline.view','followups.view','followups.manage',
  ...
  sales: new Set([
    'dashboard.view','leads.view','leads.create','leads.update','leads.export','pipeline.view','followups.view','followups.manage',
    'calls.view','calls.manage','appointments.view','appointments.manage','projects.view','units.view','tasks.view','tasks.manage',
