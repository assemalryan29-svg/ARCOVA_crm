...
const ROLE_PERMISSIONS = {
  ...
  manager: new Set([
    ...
    'pipeline.view','pipeline.manage','automation.view','automation.manage','followups.view','followups.manage','calls.view','calls.manage','appointments.view','appointments.manage',
    'projects.view','projects.manage','units.view','units.manage','tasks.view','tasks.manage','campaigns.view','campaigns.manage',
    'deals.view','deals.manage','reservations.view','reservations.manage','finance.view','reports.view','reports.export','views.view','views.manage',
    'teams.view','teams.manage','users.view','audit.view'
  ]),
  team_leader: new Set([
    'dashboard.view','leads.view','leads.create','leads.update','pipeline.view','pipeline.manage','automation.view','followups.view','followups.manage',
    'calls.view','calls.manage','appointments.view','appointments.manage','projects.view','units.view','tasks.view','tasks.manage','campaigns.view',
    'deals.view','deals.manage','reservations.view','reservations.manage','campaigns.view','reports.view','views.view','views.manage','teams.view'
  ]),
  sales: new Set([
    ...
    'calls.view','calls.manage','appointments.view','appointments.manage','projects.view','units.view','tasks.view','tasks.manage','campaigns.view',
    'deals.view','deals.manage','reservations.view','reservations.manage','reports.view','views.view','views.manage'
  ]),
